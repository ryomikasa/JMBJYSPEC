...
#   s.resources = ["BJPlaybackUI/images/**/*.xcassets", "strings/**/*.lproj"]
  ...
  ## framework
   ...
   s.ios.resource             = 'frameworks/BJPlaybackUI.framework/Versions/A/Resources/BJPlaybackUI.bundle'
  ...
  s.dependency 'BJPlaybackCore', '~> 1.4.7'
  s.dependency 'BJLiveBase', '~> 1.3.7'
