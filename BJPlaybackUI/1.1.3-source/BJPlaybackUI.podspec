...
TODO: Add long description of the pod here.
  ...
  # # framework
  # s.ios.preserve_paths       = 'frameworks/BJPlaybackUI.framework'
  # s.ios.source_files         = 'frameworks/BJPlaybackUI.framework/Versions/A/Headers/**/*.h'
  # s.ios.public_header_files  = 'frameworks/BJPlaybackUI.framework/Versions/A/Headers/**/*.h'
  # s.ios.resource             = 'frameworks/BJPlaybackUI.framework/Versions/A/Resources/**/*'
  # s.ios.vendored_frameworks  = 'frameworks/BJPlaybackUI.framework'

  s.xcconfig = {"ENABLE_BITCODE" => "NO", "CLANG_ALLOW_NON_MODULAR_INCLUDES_IN_FRAMEWORK_MODULES" => "YES"}

  s.dependency 'BJPlaybackCore', '~> 1.1.4'
  s.dependency 'BJLiveBase/Ext', '~> 1.1.0'
