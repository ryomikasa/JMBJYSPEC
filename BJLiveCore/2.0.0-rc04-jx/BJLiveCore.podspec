Pod::Spec.new do |s|
    ...
    s.dependency "BJLiveBase", "2.0.0-rc"
    s.dependency "BJLiveBase/Base", "2.0.0-rc"
    s.dependency "BJLiveBase/Networking", "2.0.0-rc"
    s.dependency "BJLiveBase/Networking+BaijiaYun", "2.0.0-rc"
    s.dependency "BJLiveBase/PocketSocket/Client", "2.0.0-rc"
    s.dependency "BJLiveBase/WebImage/BJLWebImage", "2.0.0-rc"
    s.dependency "BJLiveBase/WebImage/AFNetworking", "2.0.0-rc"
    s.dependency "BJLiveBase/YYModel", "2.0.0-rc"
