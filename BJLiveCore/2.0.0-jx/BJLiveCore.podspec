Pod::Spec.new do |s|
    ...
    s.dependency "BJLiveBase", "~> 2.0.0"
    s.dependency "BJLiveBase/Base", "~> 2.0.0"
    s.dependency "BJLiveBase/Networking", "~> 2.0.0"
    s.dependency "BJLiveBase/Networking+BaijiaYun", "~> 2.0.0"
    s.dependency "BJLiveBase/PocketSocket/Client", "~> 2.0.0"
    s.dependency "BJLiveBase/WebImage/BJLWebImage", "~> 2.0.0"
    s.dependency "BJLiveBase/WebImage/AFNetworking", "~> 2.0.0"
    s.dependency "BJLiveBase/YYModel", "~> 2.0.0"
