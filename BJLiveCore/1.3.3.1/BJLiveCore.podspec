Pod::Spec.new do |s|
    ...
    s.subspec 'weak' do |ss|
        ss.ios.preserve_paths       = 'frameworks/weak/BJLiveCore.framework'
        ss.ios.source_files         = 'frameworks/weak/BJLiveCore.framework/Versions/A/Headers/**/*.h'
        ss.ios.public_header_files  = 'frameworks/weak/BJLiveCore.framework/Versions/A/Headers/**/*.h'
        # ss.ios.resource             = 'frameworks/BJLiveCore.framework/Versions/A/Resources/**/*'
        ss.ios.vendored_frameworks  = 'frameworks/weak/BJLiveCore.framework'
        ss.libraries                = ["resolv"]
        ss.frameworks               = ['CoreGraphics', 'CoreTelephony', 'Foundation', 'UIKit', 'WebKit']
        ss.dependency 'BJLiveCore/BJHLMediaPlayer.weak'
        ss.dependency 'BJLLogStat', '~> 0.9.1'
    end
    ...
    s.subspec 'BJHLMediaPlayer.weak' do |ss|
        ss.xcconfig = {
            'CLANG_ALLOW_NON_MODULAR_INCLUDES_IN_FRAMEWORK_MODULES' => 'YES',
            "ENABLE_BITCODE" => "NO"
        }
