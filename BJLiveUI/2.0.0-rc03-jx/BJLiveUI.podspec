Pod::Spec.new do |s|
    ...
    s.subspec 'static.dependencies' do |ss|
        ...
        ss.dependency "BJLiveBase", '2.0.0-rc'
        ss.dependency "BJLiveBase/Base", '2.0.0-rc'
        ss.dependency "BJLiveBase/Auth", '2.0.0-rc'
        ss.dependency "BJLiveBase/HUD", '2.0.0-rc'
        ss.dependency "BJLiveBase/Networking", '2.0.0-rc'
        ss.dependency "BJLiveBase/WebImage/AFNetworking", '2.0.0-rc'
        
        ss.dependency "BJLiveCore", "2.0.0-rc04-jx"
