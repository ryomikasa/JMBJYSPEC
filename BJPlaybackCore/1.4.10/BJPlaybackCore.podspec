Pod::Spec.new do |s|
  ...
  s.subspec 'static' do |ss|
      ...
      ss.dependency 'BJLiveCore', '~> 1.3.10'
      ss.dependency 'BJPlayerManagerCore', '~> 1.4.10'
  end
  ...
  s.subspec 'weak' do |ss|
      ...
      ss.ios.public_header_files  = 'BJPlaybackCore/BJPlaybackCore.framework/Versions/A/Headers/**/*.h'
      ss.ios.vendored_frameworks  = 'BJPlaybackCore/BJPlaybackCore.framework'
      ss.dependency 'BJLiveCore', '1.3.10-weak'
      ss.dependency 'BJPlayerManagerCore/weak', '~> 1.4.10'
  end 
