...
Pod::Spec.new do |s|
  ...
  s.subspec "static" do |ss|
   ...
   s.subspec "weak" do |ss|
    ...
    s.dependency 'BJLiveBase/Base', '~> 1.3.9'
    s.dependency 'BJLiveBase/YYModel', '~> 1.3.9'
    s.dependency 'BJLiveBase/Networking', '~> 1.3.9'
    s.dependency 'BJLiveBase/Networking+BaijiaYun', '~> 1.3.9'
